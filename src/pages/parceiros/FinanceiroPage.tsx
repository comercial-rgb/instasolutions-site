...
export default function ParceirosFinanceiroPage() {
  return (
    <>
      <SEOHead
        title="Parceiros | Portal Financeiro | InstaSolutions"
        description="Portal financeiro para parceiros InstaSolutions."
        canonical={`${DOMAIN}/parceiros/financeiro`}
      />
      ...
      <section className="min-h-[50vh] flex flex-col items-center justify-center text-center px-4 py-16">
        ...
        <p className="text-neutral-500 max-w-sm">
          O portal financeiro para parceiros está sendo preparado. Em breve estará disponível.
        </p>
      </section>
    </>
  );

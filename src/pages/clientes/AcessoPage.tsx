...
export default function AcessoPage() {
  ...
  return (
    <>
      <SEOHead
        title="Clientes | Acesso ao Sistema | InstaSolutions"
        description="Acesse o sistema de gestão de frotas InstaSolutions."
        canonical={`${DOMAIN}/clientes/acesso`}
      />
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-center">
        <h1 className="text-2xl sm:text-3xl font-bold mb-3" style={{ color: COLORS.azulCorp }}>
          {t('access.welcome')} {t('access.client')}
        </h1>
        <p className="text-neutral-600 mb-8">{t('access.description')}</p>

        <div className="grid sm:grid-cols-2 gap-6 max-w-2xl mx-auto">
          <AccessCard title={t('access.maintenanceTracking')} href={APP_URL_GERAL} />
        ...
        <div className="mt-10">
          <img
            ...
            alt="Tela de acesso ao sistema — clientes"

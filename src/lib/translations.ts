...
const translations = {
  pt: {
    ...
    'jobs.cvLabel': 'Currículo em PDF',
    'jobs.cvHelp': 'Somente PDF · máximo 5 MB',
    'jobs.errorFileRequired': 'Anexe seu currículo em PDF para continuar.',
  ...
  en: {
    ...
    'jobs.cvLabel': 'Résumé as PDF',
    'jobs.cvHelp': 'PDF only · max 5 MB',
    'jobs.errorFileRequired': 'Please attach your résumé as a PDF to continue.',
